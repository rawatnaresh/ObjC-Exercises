...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    self.hypnosisView = [[BNRHyponsisView alloc] initWithFrame:screenRect];
    
    // Create a screen-sized scroll view
    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:screenRect];
    
    // Set hypnosisView as scrollview delegate
    scrollView.delegate = self.hypnosisView;
    ...
    // add hypnosis view as subview of scrollview
    [scrollView addSubview:self.hypnosisView];
    
    // add scrollview as subview of window
